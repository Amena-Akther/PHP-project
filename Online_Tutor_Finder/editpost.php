...
<div>
	<div>
		...
		<div class="topnav">
			<div class="parent2">
		  <div class="test1 bimage1"><a href=""><img src="image/tech.jpg" title="IT Solution" style="border-radius: 50%;" width="42" height="42"></a></div>
		  ...
		  <div class="test4"><a href="#"><img src="image/teaching.jpg" title="Tution" style="border-radius: 50%;" width="42" height="42"></a></div>
				...
				?>
			  	...
			  	<div class="itemrow">
			  			...
			  			<div style="width: 80%; float: left;">
							...
							<div class="divp35"><input <?php $sub1=strstr($sub, "phonetics"); if($sub1 != '') echo 'checked'; ?> type="checkbox" name="sub_list[]" value="phonetics"><span>phonetics</span></div>
			  			</div>
			  		</div>
					...
					<div class="itemrow">
				  	...
				  	<div class="itemrow">
				  			...
				  			<div style="width: 80%; float: left;">
				  				<?php echo '<input type="text" name="location" value="'.$location.'" placeholder="e.g:Bahaddarhat,chittagong">'; ?>
				  			</div>
				  		</div>
					<div class="itemrow">
				  			<div style="width: 20%; float: left;">
							...
							<div style="width: 80%; float: left;">
							 ...
							 <option value="None">None</option>
							  <option value="NorthSouth University"> NorthSouth University</option>
							  <option value="Brac University">Brac University</option>
							  <option value="Dhaka Univesity">Dhaka Univesity</option>
							  <option value="Chittagong Univesity">Chittagong Univesity</option>
					...
					<div class="itemrow">
				  			...
				  			<div style="width: 20%; float: left;">
				  				<p><?php echo '<input name="deadline" type="text" id="datepicker" placeholder="e.g: 10/02/2020" value="'.$deadline.'">'; ?></p>
				  			</div>
				  	</div>
